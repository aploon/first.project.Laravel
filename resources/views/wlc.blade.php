...
@section('title')
    Analytics Dashboard - This is an example dashboard created using build-in elements and components.
@endsection
...
@section('main-content')
    <div class="content-component">
        <div class="mbg-3 alert alert-info alert-dismissible fade show" role="alert">
            ...
            </span> This dashboard example was created using only the available elements and components, no
            additional
            SCSS was written!
        </div>
        <div class="row">
